...
Date | Topic | Note 
--- | --- | ---
Monday, November 1st 6pm - 8pm | Command Line Interface & Control Flow | You must have access to a working VM, see [vm_setup_tutorial.pdf](files/vm_setup_tutorial.pdf). Assignment link: https://classroom.github.com/a/7Qzr-KMS [Slides](files/cmpsc297_week1.pdf)
